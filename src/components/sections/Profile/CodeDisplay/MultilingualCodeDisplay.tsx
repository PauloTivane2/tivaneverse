  ...
  const codeSnippets = [
    ...
    },
    {
      ...
      code: [
        ...
        `\\section{Experiência}`,
        `\\begin{itemize}`,
        `  \\item Desenvolvimento Web Full-Stack`,
        `  \\item Aplicativos mobile com Flutter`,
        `  \\item Bancos de dados relacionais (MySQL)`,
        `\\end{itemize}`,
        ``,
        `\\section{Contato}`,
        `Email: \\texttt{contato@portfolio.dev}`,
        ``,
        `\\end{document}`,
    ...
    },
    {
      ...
      code: [
        ...
        ``,
        `void main() {`,
        `  runApp(const AppIncrivel());`,
        `}`,
        ``,
        `class AppIncrivel extends StatelessWidget {`,
        `  const AppIncrivel({super.key});`,
        ``,
        ...
        `              const Text('🚀 60 FPS nativos em iOS + Android!'),`,
        `            ],`,
        `          ),`,
        `        ),`,
        `      ),`,
